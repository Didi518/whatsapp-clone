...
const MediaDropdown = () => {
  ...
  const handleSendImage = async () => {
    ...
    try {
      ...
      toast.error("Echec lors de l'envoi de l'image")
    } finally {
      setIsLoading(false)
    }
  }
  ...
  const handleSendVideo = async () => {
    ...
    try {
      ...
      toast.error("Echec lors de l'envoi de la vidéo")
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          ...
          <DropdownMenuItem onClick={() => videoInput.current!.click()}>
            <Video size={18} className="mr-1" /> Vidéo
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
    </>
...
const MediaVideoDialog = ({
  ...
  return (
    ...
    >
      <DialogContent>
        <DialogDescription>Vidéo</DialogDescription>
